...
import griffphys from './thumbnails/griff-physics1.png';
import griffpen from './thumbnails/griff-amazing-pen.png'
import griffflappy from './thumbnails/griff-flappy.png';
import griffparticle1 from './thumbnails/griff-particle1.png';
import griffparticle2 from './thumbnails/griff-particle2.png';
import griffcatchgame from './thumbnails/griff-catch-game.png';
import griffaboutme from './thumbnails/griff-about-me.png';
import griffmakestory from './thumbnails/griff-make-story.png';
import griffmakeroom from './thumbnails/griff-make-room.png';
import griffdrawbackdrop from './thumbnails/griff-draw-backdrop.png';
import griffvirtualtown from './thumbnails/griff-virtual-town.png';
...
export default {
    ...
    'griff-physics':{
        name: (
            <FormattedMessage
                defaultMessage="Griffpatch: Physics in Scratch"
                description="Griffpatch Phsyics tutorial"
                id="gui.griff.tutorials.ball"
            />
        ),
        tags: ['griffpatch'],
        img: griffphys,
    ...
    'griff-pen':{
        name: (
            <FormattedMessage
                defaultMessage="Griffpatch: Amazing Pen Effects"
                description="Griffpatch Pen tutorial"
                id="gui.griff.tutorials.amazing.pen"
            />
        ),
        tags: ['griffpatch'],
        img: griffpen,
    ...
    'griff-flappy':{
        name: (
            <FormattedMessage
                defaultMessage="TechWizard: Flappy Bird Tutorial"
                description="TechWizard Flappy Bird Tutorial"
                id="gui.griff.tutorials.flappy.bird"
            />
        ),
        tags: ['griffpatch'],
        img: griffflappy,
    ...
    'griff-particle1':{
        name: (
            <FormattedMessage
                defaultMessage="Griffpatch: [Part1]Fireworks and Particle Effects"
                description="[Part1]Fireworks and Particle Effects"
                id="gui.griff.tutorials.particle.effect1"
            />
        ),
        tags: ['griffpatch'],
        img: griffparticle1,
        steps:[{
            video: 'griff-particle1'
        }],
        urlId: 'griff-particle1'
    },
    'griff-particle2':{
        name: (
            <FormattedMessage
                defaultMessage="Griffpatch: [Part2]Fireworks and Particle Effects"
                description="[Part2]Fireworks and Particle Effects"
                id="gui.griff.tutorials.particle.effect2"
            />
        ),
        tags: ['griffpatch'],
        img: griffparticle2,
        steps:[{
            video: 'griff-particle2'
        }],
        urlId: 'griff-particle2'
    },
    'griff-catch-game':{
        name: (
            <FormattedMessage
                defaultMessage="ScratchTeam: Catch Game Tutorial"
                description="ScratchTeam: Catch Game Tutorial"
                id="gui.griff.tutorials.catch.game"
            />
        ),
        tags: ['beginner'],
        img: griffcatchgame,
        steps:[{
            video: 'griff-catch-game'
        }],
        urlId: 'griff-catch-game'
    },
    'griff-about-me':{
        name: (
            <FormattedMessage
                defaultMessage="ScratchTeam: About Me Tutorial"
                description="ScratchTeam: About Me Tutorial"
                id="gui.griff.tutorials.about.me"
            />
        ),
        tags: ['beginner'],
        img: griffaboutme,
        steps:[{
            video: 'griff-about-me'
        }],
        urlId: 'griff-about-me'
    },
    'griff-make-story':{
        name: (
            <FormattedMessage
                defaultMessage="ScratchTeam: How to Make a Story"
                description="ScratchTeam: How to Make a Story"
                id="gui.griff.tutorials.make.story"
            />
        ),
        tags: ['beginner'],
        img: griffmakestory,
        steps:[{
            video: 'griff-make-story'
        }],
        urlId: 'griff-make-story'
    },
    'griff-make-room':{
        name: (
            <FormattedMessage
                defaultMessage="ScratchTeam: How to Make a Room"
                description="ScratchTeam: How to Make a Room"
                id="gui.griff.tutorials.make.room"
            />
        ),
        tags: ['beginner'],
        img: griffmakeroom,
        steps:[{
            video: 'griff-make-room'
        }],
        urlId: 'griff-make-room'
    },
    'griff-draw-backdrop':{
        name: (
            <FormattedMessage
                defaultMessage="ScratchTeam: How to Draw a Backdrop"
                description="ScratchTeam: How to Draw a Backdrop"
                id="gui.griff.tutorials.draw.backdrop"
            />
        ),
        tags: ['beginner'],
        img: griffdrawbackdrop,
        steps:[{
            video: 'griff-draw-backdrop'
        }],
        urlId: 'griff-draw-backdrop'
    },
    'griff-virtual-town':{
        name: (
            <FormattedMessage
                defaultMessage="ScratchTeam: How to Make a Virtual Town"
                description="ScratchTeam: How to Make a Virtual Town"
                id="gui.griff.tutorials.make.virtualtown"
            />
        ),
        tags: ['beginner'],
        img: griffvirtualtown,
        steps:[{
            video: 'griff-virtual-town'
        }],
        urlId: 'griff-virtual-town'
    }
};
